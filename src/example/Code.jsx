...
export default function Code(){
  ...
  return(
    <div>
      <div className='main'>
      <a href='https://github.com/Gummadi-Mohan-Krishna'>
        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16" style={{backgroundColor : 'white',borderRadius: '50%'}}>
